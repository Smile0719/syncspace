...
export default function Register({ onSuccess, onCancel }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Placeholder: integrate real registration backend here
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white px-4">
      <div className="max-w-md w-full bg-white border border-gray-200 rounded-2xl shadow p-6">
        <h2 className="text-2xl font-semibold text-slate-900 mb-4">Create a SyncSpace account</h2>
